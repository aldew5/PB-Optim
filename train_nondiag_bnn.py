...
from models.bnn_nondiag import BayesianNonDiag
from optimizers.diagonal import DiagHessianOptimizer
...
bnn_model = BayesianNonDiag(w0, w1, p_log_sigma=-6).to(device)
...
# Training
optimizer = DiagHessianOptimizer(bnn_model, lr=learning_rate)
...
if not LOAD_DATA:
    ...
    params = torch.load('./checkpoints/bnn/baseline2.pt', weights_only=True)
    #print("HERE", params)
